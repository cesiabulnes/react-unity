...
var Post = React.createClass({
  render: function() {
    return layout({metadata: {"id":"nativemodulesios","title":"Native Modules (iOS)","layout":"docs","category":"Guides","permalink":"docs/nativemodulesios.html","next":"nativecomponentsios"}}, content);
  }
});
