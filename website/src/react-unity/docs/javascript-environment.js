...
var Post = React.createClass({
  render: function() {
    return layout({metadata: {"id":"javascript-environment","title":"JavaScript Environment","layout":"docs","category":"Guides","permalink":"docs/javascript-environment.html","next":"activityindicatorios"}}, content);
  }
});
