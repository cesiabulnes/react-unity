...
var Post = React.createClass({
  render: function() {
    return layout({metadata: {"id":"linking-libraries","title":"Linking Libraries","layout":"docs","category":"Guides","permalink":"docs/linking-libraries.html","next":"debugging"}}, content);
  }
});
