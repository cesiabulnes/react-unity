...
var Post = React.createClass({
  render: function() {
    return layout({metadata: {"id":"getting-started","title":"Getting Started","layout":"docs","category":"Quick Start","permalink":"docs/getting-started.html","next":"tutorial"}}, content);
  }
});
