...
var Post = React.createClass({
  render: function() {
    return layout({metadata: {"id":"runningondevice","title":"Running On Device","layout":"docs","category":"Guides","permalink":"docs/runningondevice.html","next":"embedded-app"}}, content);
  }
});
