...
var Post = React.createClass({
  render: function() {
    return layout({metadata: {"id":"nativecomponentsios","title":"Native UI Components (iOS)","layout":"docs","category":"Guides","permalink":"docs/nativecomponentsios.html","next":"linking-libraries"}}, content);
  }
});
