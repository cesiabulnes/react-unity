...
var Post = React.createClass({
  render: function() {
    return layout({metadata: {"id":"embedded-app","title":"Integration with Existing App","layout":"docs","category":"Guides","permalink":"docs/embedded-app.html","next":"javascript-environment"}}, content);
  }
});
